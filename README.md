...
Execution, backend compilation, and runtime behavior remain out of scope. See [docs/implementation/non-goals.md](https://github.com/dtcs/dtcs/blob/main/docs/implementation/non-goals.md).
